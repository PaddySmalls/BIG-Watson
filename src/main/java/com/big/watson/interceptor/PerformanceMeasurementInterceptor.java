...
import com.big.watson.annotation.WatsonInterceptor;
...
public class PerformanceMeasurementInterceptor implements MethodInterceptor {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        LoggerProvider.logger.debug("Execution of method " + invocation.getMethod().getName() + " started at: " +
                LocalDateTime.now());
        Object result = invocation.proceed();
        long end = System.currentTimeMillis();
        LoggerProvider.logger.debug("Execution of method " + invocation.getMethod().getName() + " stopped at: " +
                LocalDateTime.now());
